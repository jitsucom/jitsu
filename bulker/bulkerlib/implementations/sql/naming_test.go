...
func TestNaming(t *testing.T) {
	...
	tests := []bulkerTestConfig{
		...
		},
		{
			...
			configIds: []string{ClickHouseBulkerTypeId, ClickHouseBulkerTypeId + "_replicated_db", ClickHouseBulkerTypeId + "_replicated_db_sharded"},
		},
		{
