// Browser-safe configuration/metadata only. Hashing, OAuth and HTTP live in runtime.ts.
import { z } from "zod";

import { googleCustomerId as customerId } from "../credentials";
export { GoogleAudienceCredentials, googleDataManagerOAuthIntegration } from "../credentials";
