  ...
  try {
    ...
    expect(files).toEqual(
      expect.arrayContaining([
        ...
        "src/functions/facebook/runtime.ts",
        "src/functions/facebook/reverse-meta.ts",
        "src/functions/facebook/editor.ts",
        "src/functions/facebook/audience.ts",
        "src/functions/facebook/conversions.ts",
        "src/functions/facebook/provisioning.ts",
        "src/functions/facebook/client.ts",
        "src/functions/facebook/identifiers.ts",
        "src/functions/facebook/delivery.ts",
