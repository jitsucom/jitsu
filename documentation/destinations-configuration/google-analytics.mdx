...
<Hint>
Google Analytics destination supports only <code inline="true">stream</code> mode and <b>should have</b> mapping rules
  compatible with <a href="https://developers.google.com/analytics/devguides/collection/protocol/v1/parameters">Measurement protocol requirements</a>. See mapping below
</Hint>
