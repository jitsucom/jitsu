...
<Hint>
    Amplitude destination supports only <code inline="true">stream</code> mode and <b>should have</b> mapping rules compatible with
...
destinations:
  my_amplitude:
    ...
    mode: stream
    amplitude:
      api_key: <YOUR_PIXEL_ID> #see below how to get it from Amplitude
    data_layout:
...
<table>
    ...
    <tr>
        ...
        <td>string</td>
        <td>Amplitude project API Key from the <a href="https://analytics.amplitude.com/">Project Settings</a> page.</td>
    </tr>
    </tbody>
</table>
