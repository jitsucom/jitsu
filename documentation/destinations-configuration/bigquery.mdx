...
[Create](https://cloud.google.com/storage/docs/creating-buckets) your Google Cloud Storage bucket
and give `Storage Object Admin` permission to your Google Service Account in created bucket.

<Hint>
    Read more information about <a href="https://jitsu.com/docs/configuration/google-authorization">How to create Google Service Account</a>
</Hint>