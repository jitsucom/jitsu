...
2. Set IAM Permissions (`BigQuery Data Owner` and `BigQuery Job User`) to created Google Service Account.
3. [Create](https://cloud.google.com/storage/docs/creating-buckets) Google Cloud Storage bucket
4. Give `Storage Object Admin` permission to your Google Service Account in created bucket.