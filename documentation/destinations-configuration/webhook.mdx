...
URL and Body might be configured with [GO text/template](https://golang.org/pkg/text/template/) or [JavaScript expressions](/docs/configuration/javascript-expressions). It allows to enrich HTTP request with data from JS/API events.
...
| :--- | :--- |
| `url` (required) | HTTP URL. Can be a string constant, string with [GO text/template](https://golang.org/pkg/text/template/) or [JavaScript expressions](/docs/configuration/javascript-expressions) |
| `method`| HTTP method. Optional. Default value is: `GET`|
| `body`| HTTP request JSON body. Can be a JSON constant, JSON with [GO text/template](https://golang.org/pkg/text/template/) or [JavaScript expressions](/docs/configuration/javascript-expressions) returning Object |
