...
return toMixpanel($, {additionalProperties: myProperties})
```
...
return toMixpanel($, {overriddenEventName: myEventName})
```
...
return toMixpanel($, {userProfileUpdates: userProfileUpdates})
```
