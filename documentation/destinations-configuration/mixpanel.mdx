...
return toMixpanel($, /* User Profile updates */ {},  /*Additional Event properties */ additionalProperties, /* Overridden event name*/ '')
```

You can set your own event names based on incoming event data:
```javascript
let overriddenEventName = ''
if ($.doc_path?.startsWith("/shop/")) {
    overriddenEventName = "Shop Page"
}
return toMixpanel($, /* User Profile updates */ {},  /*Additional Event properties */ {}, /* Overridden event name */ overriddenEventName)
```
...
return toMixpanel($, /* User Profile updates */ userProfileUpdates,  /*Additional Event properties */ {}, /* Overridden event name */ '')
