...
**Jitsu** code should be placed inside `$GOPATH` (see the following ["Effective Go"](https://golang.org/doc/gopath_code.html) chapter). Assuming that you didn't change the default value of GOPATH which is `~/go/` please use following commands:
