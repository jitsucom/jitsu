...
<Hint>
  Since Jitsu uses Docker out of Docker approach for running Airbyte connectors, please add mounting docker socket: <code inline={true}>/var/run/docker.sock:/var/run/docker.sock</code>.
