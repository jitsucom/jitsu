...
Jitsu Server can use `etcd` as a coordination service instead of Redis. It will still require redis to run [user recognition](/docs/other-features/retroactive-user-recognition)
