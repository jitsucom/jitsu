...
[Heroku](https://www.heroku.com/) is the easiest way to get started with **Jitsu Server**. If you don't have an active Heroku account you can [signup here](https://signup.heroku.com/)!
...
* Add your **Jitsu Server** [configuration](/docs/configuration/) in raw JSON format.
...
* After your app is deployed, you can visit the following link to confirm deployment  [https://your_app.herokuapp.com](https://your-app.herokuapp.com)

Once your backend is set up, place the following code on your web-app. (See our [JavaScript SDK 2.0 guide](/docs/sending-data/js-sdk) for fine-tuning):

```html
<script src="https://[your_app].herokuapp.com/s/lib.js" data-key="SERVER_AUTH_FROM_CONFIG" defer>
</script>
```
