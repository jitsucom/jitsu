...
[Heroku](https://www.heroku.com/about) is the easiest way to get started with **Jitsu**. If you don't have an active Heroku account you can [signup here](https://signup.heroku.com/)!
...
- For visit Jitsu, click `View App`. Also, your can visit Jitsu via `<your_app_name>.herokuapp.com` link or
`Open App` button in the right corner on of the `https://dashboard.heroku.com/apps/<your_app_name>` page.
...
Once a new [Jitsu heroku docker](https://hub.docker.com/repository/docker/jitsucom/heroku) version is created you can update
...
If you are using Jitsu constantly, once free hours will be exceeded and Heroku will put your app to sleep.
