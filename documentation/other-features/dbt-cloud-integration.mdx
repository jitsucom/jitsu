...
You can configure Jitsu to trigger [dbt Cloud job run](https://docs.getdbt.com/dbt-cloud/api#operation/triggerRun) on certain events:
...
See [dbt Cloud API docs](https://docs.getdbt.com/dbt-cloud/api#operation/triggerRun)
