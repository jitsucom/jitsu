...
Configuration via env variable - add `MAX_MIND_PATH` env variable like: `MAX_MIND_PATH=maxmind://<your license key>` or add
comma-separated certain edition ids `MAX_MIND_PATH=maxmind://<your license key>?edition_id=GeoIP2-City,GeoIP2-ISP`, or set your license key on Jitsu UI -> Geo data resolver section (available since 1.37.3 version).
