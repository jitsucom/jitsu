...
**Jitsu** applies resolved geo data during [enrichment](/docs/how-it-works/architecture#context-enrichment-step). Geo resolution means determining
...
After purchasing, you will receive a license key. Put obtained license key on Jitsu UI -> Geo data resolver section (available since 1.37.2 version) or run Jitsu with [env variable](#configuration).
...
#or
geo.maxmind_path: 'maxmind://<YOUR_MAXMIND_LICENSE_KEY>' #Jitsu will download all available MaxMind DBs from official MaxMind URL with your licence key
#or
geo.maxmind_path: 'maxmind://<YOUR_MAXMIND_LICENSE_KEY>?edition_id=GeoIP2-City,GeoIP2-ISP' #Jitsu will download only GeoIP2-City and GeoIP2-ISP
#or
