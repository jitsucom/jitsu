...
If **Jitsu Server** is deployed in a standlone mode, it should be configured via single YAML file
(read more about deployment options [here](/docs/deployment/)). We follow
...
[GitHub](https://github.com/jitsucom/jitsu/blob/master/server/config/config.template.yaml).
