...
**Jitsu** supports `ip_lookup` and __`user_agent_parse` enrichment rules per destination. Rules are executed **before** field mappings. Enrichment rule configuration has the following structure:
