...
**Jitsu** supports JavaScript language to dynamically evaluate certain destination parameters based on received event. E.g., this applies to [Table Names and Filters](docs/configuration/table-names-and-filters) and [WebHook](https://jitsu.com/docs/destinations-configuration/webhook) url and JSON body calculation.
