  ...
  <tbody>
    <tr>
      ...
      <td>if true - all not mapped fields will be added to the result JSON as-is.
        <p>if false - only fields that were mentioned in mapping rules with actions <b>move</b> will be added
    ...
    <tr>
      ...
      <td>
        ...
        <p><b>cast</b> - take into account SQL type from <b>type</b> field and apply
          it to <b>dst</b> JSON path node in SQL statements (creates/updated tables
