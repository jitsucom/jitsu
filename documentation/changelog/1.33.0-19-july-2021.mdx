...
[**Read more about Javascript Functions** ](/docs/configuration/javascript-functions) »

### Notifications

Did you have a fear of loosing the data by forgetting to link your source to the database? Fear not! 
Jitsu will automatically detect orphan sources and destinations and will immediately create a notification so that you never forget to fix the issue.
