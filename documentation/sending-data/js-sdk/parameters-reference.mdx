...
<table>
    ...
    <tr>
      <td>gdpr<br />(<span style={{whiteSpace: 'nowrap'}}>data-gdpr</span>)</td>
      <td>If set to true, Jitsu won't set any cookies and will enrich event with daily anonymous ID based on hashed user IP, user agent and day on the backend side.</td>
    </tr>
    </tbody>
</table>
