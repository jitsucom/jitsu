...
* https://github.com/jitsucom/jitsu-sdk/blob/main/core/jitsu-types/extension.d.ts
* https://github.com/jitsucom/jitsu-sdk/blob/main/core/jitsu-types/sources.d.ts
