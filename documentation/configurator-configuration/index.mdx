...
* `smtp` – email sender configuration. If not specified, email sender will be disabled.
...
smtp:
  ...
  # below is default value, change to use your own email address for From field
  from: support@jitsu.com
  # below is default value, change to use your own signature in outgoing email
  signature: Your Jitsu - an open-source data collection platform team
```
