...
* `jitsu` — Jitsu Server address configuration. Configurator UI proxies some requests from UI to Jitsu Server e.g. getting Live events and Statistics data or Destinations Test requests.
