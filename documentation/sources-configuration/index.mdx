 ...
 * Native sources (example: [Google Ads](/docs/sources/facebook-marketing), [Facebook](/docs/sources/google-ads)). Those sources are written in Go and are a part of Jitsu code-base
...
is: [facebook](/docs/sources/facebook), [google-ads](/source/facebook), [google-analytics](/docs/sources/google-analytics),
...
or [Airbyte-based](/docs/sources-configuration/aitbyte) sources
