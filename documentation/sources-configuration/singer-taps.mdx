...
| [Catalog](https://github.com/singer-io/getting-started/blob/master/docs/SPEC.md#catalog) (required) | JSON objec contains all streams (object types) and fields to download. JSON structure is standardized, but stream and field names depend on the tap. |
