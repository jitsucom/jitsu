...
function Svg(props) {
  return (
    <svg width="100%" height="100%" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <polygon id="path-1" points="0.6438 0.0005 27.479 0.0005 27.479 9.0005 0.6438 9.0005"></polygon>
        <polygon id="path-3" points="0.6437 0.0004 27.479 0.0004 27.479 9 0.6437 9"></polygon>
      </defs>
      <g
