...
export const bento = require("./bento").default()
...
export const elasticsearch = require("./elasticsearch").default()
export const facebook = require("./facebook").default()
...
export const plausible = require("./plausible").default()
