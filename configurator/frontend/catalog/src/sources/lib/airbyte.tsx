...
export const allAirbyteSources: AirbyteSource[] = [
        ...
        documentation: {
            overview: (
                <>
                    ...
                    is a web scraping and web automation platform providing both ready-made and custom solutions, an
                    open-source{" "}
                    <a target="_blank" href="https://sdk.apify.com/">
                        SDK
                    </a>{" "}
                    for web scraping, proxies, and many other tools to help you build and run web automation jobs at
                    scale. The
                    results of a scraping job are usually stored in{" "}
                    <a target="_blank" href="https://docs.apify.com/storage/dataset">
                        Apify Dataset
                    </a>
                    . This connector allows you to automatically sync the contents of a dataset to your chosen
                    destination. To
    ...
    },
    {
        ...
        stable: false,
        documentation: {
            overview: <>The Postgres source can sync tables from Postgres SQL database into destination of your
                choice.</>,
            connection: (
                <>
                    Please read{" "}
    ...
    },
    {
        ...
        documentation: {
            overview: (
                <>
                    File are often exchanged or published in various remote locations. This source aims to support an
                    expanding
                    range of file formats and storage providers. That is, every time a sync is run, all rows will be
                    copied in the
        ...
        documentation: {
            overview: (
                <>
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://developers.hubspot.com/docs/methods/pipelines/get_pipelines_for_object_type">
                        Deal Pipelines
                    </a>
                    {", "}
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://legacydocs.hubspot.com/docs/methods/engagements/get-all-engagements">
                        Engagements
                    </a>
                    {", "}
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://developers.hubspot.com/docs/methods/email/get_subscriptions_timeline">
            ...
            connection: (
                <>
                    This connector supports only authentication with API Key. To obtain API key for the account go to
                    settings
                    integrations (under the account banner) api key. If you already have an api key you can use that.
                    Otherwise
    ...
    },
    {
        ...
        docker_image_name: "airbyte/source-salesforce",
        ...
        documentation: {
            overview: (
                <>
                    ...
                    AssetRelationshipHistory, FieldPermissions, OrgWideEmailAddress, DuplicateRecordSet,
                    DashboardComponentFeed,
                    CollaborationGroupMember, ExternalEventMappingShare, UserProvisioningConfig, MessagingSessionFeed,
                    ContactFeed, MatchingRuleItem, ContactShare, AsyncApexJob, ApexTrigger, AuthConfigProviders,
                    CampaignHistory,
                    ...
                    PermissionSetGroup, Report, BackgroundOperation, ProcessDefinition, ListEmail,
                    LiveChatSensitiveDataRule,
                    PlatformCachePartition, FileSearchActivity, EmbeddedServiceDetail, UserProvMockTarget,
                    ResourcePreferenceFeed,
                    QuickText, SecureAgentPlugin, ServiceAppointmentShare, MessagingChannel, ServiceResource, Asset,
                    AuthConfig,
                    FiscalYearSettings, SkillRequirement, SkillRequirementHistory, UserPackageLicense,
                    AssociatedLocation,
                    ...
                    ProcessNode, CorsWhitelistEntry, CaseContactRole, TestSuiteMembership, LeadShare, CallCenter,
                    LoginEvent,
                    DataAssessmentMetric, MobileApplicationDetail, MessagingSession, Domain, Document, ApexClass,
                    AssociatedLocationHistory, DatacloudCompany, ResourceAbsenceHistory, ServiceResourceSkill,
                    OpportunityFeed,
                    DuplicateRule, LeadFeed, Idea, Organization, OpportunityShare, BusinessProcess,
                    ...
                    ContentWorkspaceMember, QuickTextHistory, EventLogFile, MessagingEndUserShare, ContractContactRole,
                    WorkType,
                    ...
                    CaseTeamTemplateMember, GroupMember, UserProvisioningRequest, ServiceResourceShare, Skill,
                    CaseHistory,
                    OrderFeed, WaveCompatibilityCheckItem, Event, LocationShare, TopicAssignment, TopicFeed,
                    ContentDocumentFeed,
                    ...
                    FlowInterviewShare, Dashboard, CaseTeamRole, AccountPartner, DatacloudAddress,
                    ChatterExtensionConfig,
                    OpportunityStage, AuraDefinitionBundleInfo, ResourcePreferenceHistory, UserProvisioningLog,
                    ResourceAbsenceFeed, IdpEventLog, ContentDistributionView, CollaborationGroupMemberRequest,
                    DomainSite,
                    EventFeed, BusinessHours, SecureAgentsCluster, UserShare, DataAssessmentValueMetric,
                    EntitySubscription,
                    VisualforceAccessMetrics, CspTrustedSite, Order, InstalledMobileApp, Location, UserRole, CaseFeed,
                    ContentDocument, DuplicateRecordItem, ServiceTerritoryMemberHistory, Scontrol, AssignedResourceFeed,
                    ApexLog,
                    CaseTeamMember, DocumentAttachmentMap, ServiceTerritoryMemberFeed, OrderItemFeed,
                    UserAppMenuCustomization,
                    OpportunityCompetitor, Product2History, PushTopic, ResourcePreference, WorkTypeHistory,
                    StampAssignment,
                    ...
                    SecureAgentPluginProperty, OrderItem, MessagingEndUser, ApexTestQueueItem, QuickTextShare,
                    FeedPollChoice,
                    ...
                    UserProvAccountStaging, Note, OpportunityFieldHistory, DandBCompany, MailmergeTemplate, User,
                    AuthProvider,
                    FlowInterview, VerificationHistory, AssetFeed, AuthSession, EventRelation, WorkTypeFeed,
                    UserPreference,
                    NamedCredential, ServiceResourceSkillHistory, UserProvisioningRequestShare, EmailCapture,
                    CustomBrandAsset,
                    Campaign, UserAppInfo, UserPermissionAccess, AdditionalNumber, ContentAsset, ConferenceNumber,
                    ServiceTerritory, ActionLinkGroupTemplate, CollaborationInvitation, PermissionSetLicense,
                    ApexTestSuite,
                    ExternalEventMapping, TimeSlot, OrderItemHistory, MessagingEndUserHistory, ExternalDataUserAuth,
                    AuraDefinition, LeadHistory, ServiceAppointmentStatus, EventBusSubscriber, WebLink,
                    ApexTestResultLimits,
                    Profile, CaseTeamTemplateRecord, OpportunityContactRole, CronTrigger, DatacloudContact,
                    ContentWorkspace,
                    Period, AssetShare, MessagingLink, Topic, ServiceResourceHistory, Case, EntityDefinition,
                    ResourceAbsence,
                    Partner, AssignmentRule, ListEmailShare, ContactHistory, Site, CustomBrand, EmailMessage,
                    Pricebook2History,
                    FeedPollVote, ServiceResourceSkillFeed, Account, SessionPermSetActivation, ContractHistory, Holiday,
                    EmailTemplate, ActionLinkTemplate, ReportFeed, CollaborationGroupFeed,
                    CustomObjectUserLicenseMetrics,
                    FeedAttachment, ContentDistribution, ContentFolderLink, FeedRevision, UserAppMenuItem,
                    ProcessInstanceNode,
                    AuraDefinitionBundle, TodayGoalShare, Pricebook2, CategoryData, MacroInstruction,
                    StreamingChannelShare,
                    AssignedResource, PackageLicense, Product2Feed, DashboardFeed, Task, UserLicense, SolutionHistory,
                    ContentVersionHistory, MessagingSessionHistory, DashboardComponent, CaseShare,
                    PermissionSetLicenseAssign,
                    ContactCleanInfo, Contract, Attachment, DatacloudPurchaseUsage, ServiceTerritoryFeed, CronJobDetail,
                    ApexPageInfo, PlatformCachePartitionType, Contact, Community, Stamp, OperatingHoursFeed,
                    ExternalDataSource
                </>
            ),
            connection: (
                <>
                    ...
                    while keeping in mind the edits we suggest below for setting up a Salesforce app that can pull data
                    from
                    Salesforce and locating the credentials you need to provide. If your salesforce URL does not take
                    the form{" "}
                    <b>X.salesforce.com</b>, use your actual Salesforce domain name. For example, if your Salesforce URL
                    is{" "}
                    <b>awesomecompany.force.com</b> then use that instead of <b>awesomecompany.salesforce.com</b>. When
                    running a{" "}
        ...
        documentation: {
            overview: (
                <>
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://mailchimp.com/developer/api/marketing/campaigns/get-campaign-info/">
                        Campaigns
                    </a>
                </>
            ),
            connection: (
                <>
                    To start syncing Mailchimp data you'll need : Your Mailchimp username. Often this is just the email
                    address or
        ...
        documentation: {
            overview: (
                <>
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-screen-tabs/">
                        Screen tabs
                    </a>
                    {", "}
                    <a
        ...
        documentation: {
            ...
            connection: (
                <>
                    Please read{" "}
                    <a target="_blank"
                       href="https://docs.airbyte.io/integrations/sources/google-adwords#getting-started">
                        setup guide
                    </a>{" "}
                    for more information.
                </>
    ...
    },
    {
        ...
        documentation: {
            overview: (
                <>
                    This source can sync data for the Instagram Business Account available in the Facebook Graph
                    API{": "}
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://developers.facebook.com/docs/instagram-api/reference/ig-user/insights">
                        User Insights
                    </a>
                    {", "}
                    <a target="_blank"
                       href="https://developers.facebook.com/docs/instagram-api/reference/ig-user/media">
                        Media
                    </a>
                    {", "}
                    <a target="_blank"
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://developers.facebook.com/docs/instagram-api/reference/ig-user/stories/">
                        Stories
                    </a>
                    {", "}
                    <a target="_blank"
        ...
        documentation: {
            overview: (
                <>
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://marketplace.zoom.us/docs/api-reference/zoom-api/meetings/meetingregistrants">
                        Meeting Registrants
                    </a>
                    {", "}
                    <a target="_blank"
                       href="https://marketplace.zoom.us/docs/api-reference/zoom-api/meetings/meetingpolls">
                        Meeting Polls
                    </a>
                    {", "}
                    <a
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://marketplace.zoom.us/docs/api-reference/zoom-api/webinars/webinarpanelists">
                        Webinar Panelists
                    </a>
                    {", "}
                    <a target="_blank"
                       href="https://marketplace.zoom.us/docs/api-reference/zoom-api/webinars/webinarregistrants">
                        Webinar Registrants
                    </a>
                    {", "}
                    <a target="_blank"
                       href="https://marketplace.zoom.us/docs/api-reference/zoom-api/webinars/webinarabsentees">
                        Webinar Absentees
                    </a>
                    {", "}
                    <a target="_blank"
                       href="https://marketplace.zoom.us/docs/api-reference/zoom-api/webinars/webinarpolls">
                        Webinar Polls
                    </a>
                    {", "}
                    <a
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://marketplace.zoom.us/docs/api-reference/zoom-api/webinars/gettrackingsources">
    ...
    },
    {
        ...
        documentation: {
            overview: (
                <>
                    The Sendgrid source syncs campaigns and lists streams. There are two different kinds of marketing
                    campaigns,
                    "legacy marketing campaigns" and "new marketing campaigns". Only "new marketing campaigns" are
                    supported.
                </>
            ),
            connection: (
                <>
                    ...
                    . We recommend creating a key specifically for access. This will allow you to control which
                    resources should
                    be able to access. The API key should be read-only on all resources except Marketing, where it needs
                    Full
                    Access.
                </>
            ),
        ...
        documentation: {
            overview: (
                <>
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://docs.looker.com/reference/api-and-integration/api-reference/v3.1/workspace">
                        Workspaces
                    </a>
                </>
            ),
        ...
        documentation: {
            ...
            connection: (
                <>
                    ...
                    page and enter needed info. After registration and login you will see your API Access Key, also you
                    may find
                    it{" "}
                    ...
                    ) this means that you will have 2 limitations: 1000 API calls per month and You won't be able to
                    specify the
        ...
        documentation: {
            ...
            connection: (
                <>
                    Generate a API key using the{" "}
                    <a target="_blank"
                       href="https://docs.recurly.com/docs/api-keys#section-find-or-generate-your-api-key">
                        Recurly documentation
                    </a>
                    . We recommend creating a restricted, read-only key specifically for access. This will allow you to
                    control
        ...
        documentation: {
            ...
            connection: (
                <>
                    Please read{" "}
                    <a target="_blank"
                       href="https://docs.airbyte.io/integrations/sources/google-search-console#getting-started">
                        setup guide
                    </a>{" "}
                    for more information.
                </>
        ...
        documentation: {
            overview: (
                <>
                    ...
                    - v1.0 and beta. Beta version contains new or enhanced APIs that are still in preview status. But
                    APIs in
                    preview status are subject to change, and may break existing scenarios without notice. It isn't
                    recommended
                    taking a production dependency on APIs in the beta endpoint. This Source Connector is based on
                    a{" "}
                    <a
                        target="_blank"
                    ...
                    <a target="_blank"
                       href="https://docs.microsoft.com/en-us/graph/api/user-list?view=graph-rest-beta&tabs=http">
                        users
                    </a>
                    {", "}
                    <a
            ...
            connection: (
                <>
                    Please read{" "}
                    <a target="_blank"
                       href="https://docs.airbyte.io/integrations/sources/microsoft-teams#getting-started">
                        setup guide
                    </a>{" "}
                    for more information.
                </>
        ...
        documentation: {
            overview: (
                <>
                    ...
                    to serve and retrieve information about Pokémon. This connector should be primarily used for
                    educational
                    purposes or for getting a trial source up and running without needing any dependencies. Schema is
                    located{" "}
                    <a
                        target="_blank"
            ...
            connection: (
                <>
                    As this API is fully open and is not rate-limited, no authentication or rate-limiting is performed,
                    so you can
        ...
        documentation: {
            overview: (
                <>
                    ...
                    <a target="_blank"
                       href="https://developers.google.com/admin-sdk/reports/v1/get-start/getting-started">
                        Reports API
                    </a>
                    . For gaining insights on content management with Google Drive activity reports and Audit
                    administrator
                    actions. It supports the following streams{": "}
                    <a target="_blank"
                       href="https://developers.google.com/admin-sdk/reports/v1/guides/manage-audit-admin">
                        admin
                    </a>
                    {", "}
                    <a target="_blank"
                       href="https://developers.google.com/admin-sdk/reports/v1/guides/manage-audit-drive">
                        drive
                    </a>
                    {", "}
                    <a target="_blank"
                       href="https://developers.google.com/admin-sdk/reports/v1/guides/manage-audit-login">
                        logins
                    </a>
                    {", "}
                    <a target="_blank"
                       href="https://developers.google.com/admin-sdk/reports/v1/guides/manage-audit-mobile">
                        mobile
                    </a>
                </>
            ),
        ...
        documentation: {
            overview: (
                <>
                    ...
                    <a target="_blank"
                       href="https://developers.google.com/admin-sdk/directory/v1/get-start/getting-started">
            ...
            connection: (
                <>
                    Please read{" "}
                    <a target="_blank"
                       href="https://docs.airbyte.io/integrations/sources/google-directory#getting-started">
                        setup guide
                    </a>{" "}
                    for more information.
                </>
        ...
        documentation: {
            overview: (
                <>
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://developer.zendesk.com/rest_api/docs/chat/departments#list-departments">
                        Departments
                    </a>
                    {", "}
        ...
        documentation: {
            overview: (
                <>
                    ...
                    Sheets,
                    Smartsheets only allows one sheet per Smartsheet - so a given connector instance can sync only one
                    sheet at a
                    time. To replicate multiple spreadsheets, you can create multiple instances of the Smartsheet
                    Source, reusing
    ...
    },
    {
        ...
        documentation: {
            overview: (
                <>
                    The S3 source enables syncing of file-based tables with support for multiple files using glob-like
                    pattern
                    matching, and both Full Refresh and Incremental syncs, using the last_modified property of files to
                    determine
                    incremental batches. You can choose if this connector will read only the new/updated files, or all
                    the
        ...
        documentation: {
            overview: (
                <>
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://help.getharvest.com/api-v2/invoices-api/invoices/invoice-messages/">
                        Invoice Messages
                    </a>
                    {", "}
                    <a target="_blank"
                       href="https://help.getharvest.com/api-v2/invoices-api/invoices/invoice-payments/">
                        Invoice Payments
                    </a>
                    {", "}
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://help.getharvest.com/api-v2/invoices-api/invoices/invoice-item-categories/">
                        Invoice Item Categories
                    </a>
                    {", "}
                    <a target="_blank"
                       href="https://help.getharvest.com/api-v2/estimates-api/estimates/estimate-messages/">
                        Estimate Messages
                    </a>
                    {", "}
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://help.getharvest.com/api-v2/expenses-api/expenses/expense-categories/">
                        Expense Categories
                    </a>
                    {", "}
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://help.getharvest.com/api-v2/projects-api/projects/user-assignments/">
                        Project User Assignments
                    </a>
                    {", "}
                    <a target="_blank"
                       href="https://help.getharvest.com/api-v2/projects-api/projects/task-assignments/">
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://help.getharvest.com/api-v2/reports-api/reports/project-budget-report/">
            ...
            connection: (
                <>
                    This connector supports only authentication with API Key. To obtain API key: Go to Account Settings
                    page and
                    Under Integrations section press Authorized OAuth2 API Clients button. New page will be opened on
                    which you
        ...
        documentation: {
            ...
            connection: (
                <>
                    ...
                    you will
                    need to generate a Tempo OAuth 2.0 token for an individual user. Go to <b>Tempo {"->"} Settings</b>,
                    scroll
        ...
        documentation: {
            overview: (
                <>
                    ...
                    {": "}
                    <a target="_blank"
                       href="https://developer.zendesk.com/rest_api/docs/voice-api/stats#show-account-overview">
                        Account{" "}
                    </a>
                    {", "}
                    <a
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://developer.zendesk.com/rest_api/docs/voice-api/stats#list-agents-activity">
                        Agents Activity
                    </a>
                    {", "}
                    <a target="_blank"
                       href="https://developer.zendesk.com/rest_api/docs/voice-api/stats#show-agents-overview">
                        Agents{" "}
                    </a>
                    {", "}
                    <a
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://developer.zendesk.com/rest_api/docs/voice-api/greetings#list-greetings">
                        Greetings
                    </a>
                    {", "}
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://developer.zendesk.com/rest_api/docs/voice-api/ivr_routes#list-ivr-routes">
                        IVR Routes
                    </a>
                    {", "}
                    <a
        ...
        documentation: {
            overview: (
                <>
                    ...
                    {": "}
                    <a target="_blank"
                       href="https://developers.cart.com/docs/rest-api/restapi.json/paths/~1customers/get">
                        CustomersCart
                    </a>
                    {", "}
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://developers.cart.com/docs/rest-api/restapi.json/paths/~1order_payments/get">
                        OrderPayments
                    </a>
                    {", "}
                    <a target="_blank"
                       href="https://developers.cart.com/docs/rest-api/restapi.json/paths/~1products/get">
                        Products
                    </a>
                </>
            ),
        ...
        documentation: {
            overview: (
                <>
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://apidocs.klaviyo.com/reference/lists-segments#get-global-exclusions">
                        GlobalExclusions
                    </a>
                    {", "}
        ...
        documentation: {
            ...
            connection: (
                <>
                    ...
                    . Different Okta APIs require different admin privilege levels. API tokens inherit the privilege
                    level of the
                    admin account used to create them. Sign in to your Okta organization as a user with{" "}
                    <a target="_blank"
                       href="https://help.okta.com/en/prod/okta_help_CSH.htm#ext_Security_Administrators">
                        administrator privileges
                    </a>{" "}
                    Access the API page: In the Admin Console, select API from the Security menu and then select the
                    Tokens tab.
        ...
        documentation: {
            ...
            connection: (
                <>
                    Please read{" "}
                    <a target="_blank"
                       href="https://support.rechargepayments.com/hc/en-us/articles/360008829993-ReCharge-API-">
        ...
        documentation: {
            overview: (
                <>
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://apidocs.chargebee.com/docs/api/customers?prod_cat_ver=2#list_customers">
                        Customers
                    </a>
                    {", "}
                    <a target="_blank"
                       href="https://apidocs.chargebee.com/docs/api/invoices?prod_cat_ver=2#list_invoices">
                        Invoices
                    </a>
                    {", "}
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://apidocs.chargebee.com/docs/api/item_prices?prod_cat_ver=2#list_item_prices">
                        Item Prices
                    </a>
                    {", "}
                    <a
        ...
        documentation: {
            overview: (
                <>
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://developers.pipedrive.com/docs/api/v1/ActivityFields#getActivityFields">
                        ActivityFields
                    </a>
                    {", "}
        ...
        documentation: {
            overview: (
                <>
                    ...
                    {": "}
                    <a target="_blank"
                       href="https://developer.squareup.com/explorer/square/catalog-api/search-catalog-objects">
                        Items
                    </a>
                    {", "}
                    <a target="_blank"
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://developer.squareup.com/explorer/square/locations-api/list-locations">
                        Locations
                    </a>
                    {", "}
                    <a
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://developer.squareup.com/explorer/square/labor-api/list-team-member-wages">
                        List Team Member Wages
                    </a>
                    {", "}
                    <a target="_blank"
                       href="https://developer.squareup.com/explorer/square/customers-api/list-customers">
                        Customers
                    </a>
                    {", "}
        ...
        documentation: {
            ...
            connection: (
                <>
                    ...
                    . Your token should have the read_api scope, that Grants read access to the API, including all
                    groups and
        ...
        documentation: {
            overview: (
                <>
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://marketingapi.snapchat.com/docs/#get-all-ad-squads-under-an-ad-account">
                        Ad Squad
                    </a>
                    {", "}
            ...
            connection: (
                <>
                    Please read{" "}
                    <a target="_blank"
                       href="https://docs.airbyte.io/integrations/sources/snapchat-marketing#setup-guide">
                        setup guide
                    </a>{" "}
                    for more information.
                </>
        ...
        documentation: {
            overview: (
                <>
                    ...
                    {": "}
                    <a target="_blank"
                       href="https://www.twilio.com/docs/usage/api/account#read-multiple-account-resources">
                        Accounts
                    </a>
                    {", "}
                    <a target="_blank"
                       href="https://www.twilio.com/docs/usage/api/address#read-multiple-address-resources">
                        Addresses
                    </a>
                    {", "}
                    <a target="_blank"
                       href="https://www.twilio.com/docs/usage/monitor-alert#read-multiple-alert-resources">
                        Alerts
                    </a>
                    {", "}
                    <a
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://www.twilio.com/docs/voice/api/call-resource#create-a-call-resource">
                        Calls
                    </a>
                    {", "}
                    <a
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://www.twilio.com/docs/sms/api/media-resource#read-multiple-media-resources">
                        Message Media
                    </a>
                    {", "}
                    <a
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://www.twilio.com/docs/voice/api/queue-resource#read-multiple-queue-resources">
                        Queues
                    </a>
                    {", "}
                    <a target="_blank"
                       href="https://www.twilio.com/docs/voice/api/recording#read-multiple-recording-resources">
                        Recordings
                    </a>
                    {", "}
                    <a
            ...
            connection: (
                <>
                    ...
                    will use your
                    Twilio Account SID as the username and your Auth Token as the password for HTTP Basic
        ...
        documentation: {
            overview: (
                <>
                    ...
                    <a target="_blank"
                       href="https://developer.zendesk.com/api-reference/apps/apps-support-api/introduction/">
                        Zendesk Support API
                    </a>
                    {": "}
        ...
        documentation: {
            ...
            connection: (
                <>
                    ...
                    to obtain an API key.In addition, to understand how to configure the dataset path and query
                    parameters, follow
            ...
            connection: (
                <>
                    ...
                    <ul>
                        ...
                        <li>In the upper-right corner, in the drop-down menu next to your profile photo, click My
                            Account
                        </li>
                        ...
                        <li>
                            Choose needed scopes (API actions this token can perform - or permissions it has). See here
                            for more
                            details on scopes
                        </li>
        ...
        documentation: {
            overview: (
                <>
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://developer.zendesk.com/api-reference/custom-data/custom-objects-api/jobs/">
                        Jobs
                    </a>
                    {", "}
                    <a target="_blank"
                       href="https://developer.zendesk.com/api-reference/custom-data/custom-objects-api/limits/">
                        Limits
                    </a>
                </>
            ),
        ...
        documentation: {
            overview: (
                <>
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://devdocs.prestashop.com/1.7/webservice/resources/content_management_system/">
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://devdocs.prestashop.com/1.7/webservice/resources/customer_messages/">
                        Customer Messages
                    </a>
                    {", "}
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://devdocs.prestashop.com/1.7/webservice/resources/product_feature_values/">
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://devdocs.prestashop.com/1.7/webservice/resources/product_option_values/">
                        Product Option Values
                    </a>
                    {", "}
                    <a target="_blank"
                       href="https://devdocs.prestashop.com/1.7/webservice/resources/product_suppliers/">
                        Product Suppliers
                    </a>
                    {", "}
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://devdocs.prestashop.com/1.7/webservice/resources/specific_price_rules/">
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://devdocs.prestashop.com/1.7/webservice/resources/stock_movement_reasons/">
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://devdocs.prestashop.com/1.7/webservice/resources/translated_configurations/">
            ...
            connection: (
                <>
                    PrestaShop enables merchants to give third-party tools access to their shop’s database through a
                    CRUD API,
                    otherwise called a{" "}
                    <a target="_blank" href="https://devdocs.prestashop.com/1.7/webservice/">
                        web service
        ...
        documentation: {
            ...
            connection: (
                <>
                    ...
                    Be aware that refresh token will expire in 90 days. You need to repeat auth process to get the new
                    one refresh
                    token.
                </>
            ),
        ...
        documentation: {
            overview: (
                <>
                    ...
                    {": "}
                    <a target="_blank"
                       href="https://developer.paypal.com/braintree/docs/reference/request/customer/search">
                        Customers
                    </a>
                    {", "}
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://developer.paypal.com/braintree/docs/reference/request/dispute/search">
                        Disputes
                    </a>
                    {", "}
                    <a target="_blank"
                       href="https://developers.braintreepayments.com/reference/response/transaction/python">
                        Transactions
                    </a>
                    {", "}
                    <a target="_blank"
                       href="https://developer.paypal.com/braintree/docs/reference/response/merchant-account">
                        Merchant Accounts
                    </a>
                    {", "}
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://developer.paypal.com/braintree/docs/reference/response/subscription">
                        Subscriptions
                    </a>
                </>
            ),
        ...
        documentation: {
            overview: (
                <>
                    ...
                    {": "} standard objects, custom objects manually added by user, custom fields in both standard and
                    custom
                    objects available in Zuora Account. The discovering of Zuora Account objects schema may take a
                    while, if you
                    add the connection for the first time, and/or you need to refresh your list of available streams.
                    Please take
                    your time to wait and don't cancel this operation, usually it takes up to 5-10 min, depending on
                    number of
        ...
        documentation: {
            overview: (
                <>
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://developer.kustomer.com/kustomer-api-docs/reference/kobjects-custom-objects">
                        KObjects
                    </a>
                    {", "}
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://developer.kustomer.com/kustomer-api-docs/reference/tags-knowledge-base">
                        Tags
                    </a>
                    {", "}
        ...
        documentation: {
            overview: (
                <>
                    This source syncs data from{" "}
                    <a target="_blank"
                       href="https://advertising.amazon.com/API/docs/en-us/what-is/amazon-advertising-api">
                        Amazon Advertising API
                    </a>
                    {": "}
                    <a target="_blank"
                       href="https://advertising.amazon.com/API/docs/en-us/reference/2/profiles#/Profiles">
                        Profiles
                    </a>
                    {", "}
                    <a
                    ...
                    {", "}
                    <a target="_blank"
                       href="https://advertising.amazon.com/API/docs/en-us/reference/sponsored-brands/2/reports">
                        Brands Reports
                    </a>
                    {", "}
                    <a
        ...
        documentation: {
            overview: (
                <>
                    ...
                    <a target="_blank"
                       href="https://developer.bigcommerce.com/api-docs/getting-started/making-requests">
                        BigCommerce API
                    </a>
                    {": "}
                    <a
            ...
            connection: (
                <>
                    <ul>
                        <li>
                            Navigate to your store’s control panel (Advanced Settings {">"} API Accounts {">"} Create
                            API Account)
                        </li>
                        <li>Create an API account.</li>
                        <li>
                            Select the resources you want to allow access to. Connector only needs read-level access.
                            (Note: The UI
                            will show all possible data sources and will show errors when syncing if it doesn't have
                            permissions to
                            access a resource)
                        </li>
    ...
    },
    {
        ...
        documentation: {
            overview: (
                <>
                    Google Analytics 4 (GA4) connector is the latest version of Google Analytics, which was introduced
                    in 2020. It offers a new data model that emphasizes events and user properties, rather than
                    pageviews and sessions. This new model allows for more flexible and customizable reporting, as well
                    as more accurate measurement of user behavior across devices and platforms.
                </>
            ),
