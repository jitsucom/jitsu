...
export const singerConfigParams: Record<string, (tap: string) => Parameter> = {
  catalogJson: (tap: string): Parameter => {
    return {
      ...
      documentation: (
        <>
          Singer <a target="_blank" href="https://github.com/singer-io/getting-started/blob/master/docs/SPEC.md#catalog">catalog</a>{" "}
  ...
  stateJson: (tap: string): Parameter => {
    return {
      ...
      documentation: (
        <>
          Singer initial <a target="_blank" href="https://github.com/singer-io/getting-started/blob/master/docs/SPEC.md#state">state</a>
