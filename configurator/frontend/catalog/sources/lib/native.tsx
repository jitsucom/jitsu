  ...
  documentation: {
    overview: (
      <>
        ...
        <a target="_blank" href="https://developers.facebook.com/docs/marketing-api/insights/">Facebook Insights API</a>. The connector
    ...
    connection: (
      <>
        ...
        <ul>
          <li>
            Go to <a target="_blank" href="https://developers.facebook.com/tools/explorer">Facebook Graph API Explorer</a> page
          </li>
        ...
        <a target="_blank" href="https://developers.facebook.com/docs/pages/access-tokens/#get-a-long-lived-user-access-token">
          Facebook article
        </a>
      </>
    ),
  ...
  documentation: {
    overview: (
      <>
        ...
        <a target="_blank" href="https://developers.google.com/google-ads/api/fields/v8/overview">Google Ads API</a>. The connector is
        highly configurable. You can compose any number of reports using{" "}
        <a target="_blank" href="https://developers.google.com/google-ads/api/fields/v8/overview_query_builder">Query Builder</a> by
      ...
      serviceAccountSpecifics: (
        <>
          ...
          <li>
            ...
            <a target="_blank" href="https://support.google.com/a/answer/162106">help center guide</a> to complete this step.
          </li>
        </>
      ),
    }),
  ...
  configParameters: [
    ...
    }),
    {
      ...
      documentation: (
        <>
          Read about{" "}
          <a target="_blank" href="https://jitsu.com/docs/sources-configuration/google-analytics#how-to-find-google-analytics-view-id">
  ...
  documentation: {
    overview: (
      <>
        ...
        <a target="_blank" href="https://developers.google.com/analytics/devguides/reporting/core/v4">Google Analytics API</a>. The
        ...
        <a target="_blank" href="https://ga-dev-tools.appspot.com/dimensions-metrics-explorer">found here</a>
      </>
    ),
    connection: googleServiceAuthDocumentation({
      oauthEnabled: true,
...
export const redis: SourceConnector = {
  ...
  documentation: {
    overview: (
      <>
        The Redis connector pulls data from <a target="_blank" href="https://redis.io/commands/get">string</a>,{" "}
        <a target="_blank" href="https://redis.io/commands/hscan">hash</a>, <a target="_blank" href="https://redis.io/commands/lrange">list</a>,{" "}
        <a target="_blank" href="https://redis.io/commands/sscan">set</a>, <a target="_blank" href="https://redis.io/commands/zscan">sorted set</a>{" "}
        keys. It works with a certain Redis key configuration as well as key pattern. Jitsu uses{" "}
        <a target="_blank" href="https://redis.io/commands/scan">scan</a> commands which prevent blocking and doesn't affect Redis
        performance.
      </>
    ),
    connection: <></>,
  ...
  documentation: {
    overview: (
      <>
        ...
        <a target="_blank" href="https://developers.amplitude.com/docs/http-api-v2">Amplitude API</a>. The connector can sync{" "}
    ...
    connection: (
      <>
        <ul>
          <li>
            Go to the <a target="_blank" href="https://analytics.amplitude.com/">Amplitude Project settings</a> page
          </li>
          <li>
