  ...
  documentation: {
    overview: (
      <>
        ...
        <a href="https://developers.google.com/google-ads/api/fields/v8/overview" target={"_blank"}>
          Google Ads API
        </a>
        . The connector is highly configurable.
        <br />
        You can compose any number of reports using{" "}
        <a href="https://developers.google.com/google-ads/api/fields/v8/overview_query_builder" target={"_blank"}>
          Query Builder
        </a>{" "}
