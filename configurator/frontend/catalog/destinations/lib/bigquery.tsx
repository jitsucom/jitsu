...
const bigQueryDestination = {
  description: (
    <>
      <a target="_blank" href="https://cloud.google.com/bigquery">Google BigQuery</a> is a fast, scalable, and easy-to-use data
      ...
      Jitsu can <a target="_blank" href="https://cloud.google.com/bigquery/streaming-data-into-bigquery">stream</a> and{" "}
      <a target="_blank" href="https://cloud.google.com/bigquery/docs/batch-loading-data">batch</a> data to Google BigQuery. Streaming
    ...
    },
    {
      ...
      documentation: (
        <>
          ...
          <a target="_blank" href="https://jitsu.com/docs/configuration/google-authorization#service-account-configuration">
