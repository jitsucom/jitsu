...
let icon: ReactNode = (
  <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" height="800" width="1200"
    ...
    <g transform="translate(0 -7.034)">
      ...
      <path clipPath="url(#c)" opacity=".07"
...
const destination = {
  description: (
    <>
      Google Cloud Storage is ideal for backups and to archive company data. It is a convenient, affordable and compliant
  ...
  parameters: [
    ...
    ...fileParameters(
      "_formData.gcsFolder",
      "_formData.gcsFormat",
      "_formData.gcsCompressionEnabled"
    )
  ],
} as const
