    ...
    const modal = Modal.info({
      ...
      content: (
        <>
          ...
          <a target="_blank" href="https://jitsu.com/docs/sending-data/js-sdk">JavaScript SDK</a> or{" "}
          <a target="_blank" href="https://jitsu.com/docs/sending-data/api">HTTP API</a>
        </>
      ),
      onOk: () => modal.destroy(),
    })
