    ...
    if (dst.deprecated) {
      ...
      Modal.confirm({
          ...
          <>
            {dst.deprecatedReplacement ? (
              <span>
                ...
                <a href={projectLink(destinationPageRoutes.newExact, { type: dst.deprecatedReplacement })}>
        ...
        onOk: () => {
          ...
          history.push(projectLink(destinationPageRoutes.newExact, { type: dst.id }))
        },
      })
    }
  }
        ...
        <div key={type}>
          ...
          <div className={styles.list}>
            {filterDestinationList(destinations[type]).map((dst: Destination) => (
              <Link
                to={projectLink(destinationPageRoutes.newExact, { type: dst.id })}
                key={dst.id}
