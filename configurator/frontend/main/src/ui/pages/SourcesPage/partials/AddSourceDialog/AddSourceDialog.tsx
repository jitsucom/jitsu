      ...
      Modal.confirm({
        ...
        content: (
          <>
            ...
            <a target="_blank" href="https://github.com/singer-io/getting-started/blob/master/docs/SPEC.md">Singer Protocol</a>
            <br />
            <br />
      ...
      Modal.info({
        ...
        content: (
          <>
            ...
            <a target="_blank" href="https://devcenter.heroku.com/articles/container-registry-and-runtime#unsupported-dockerfile-commands">
