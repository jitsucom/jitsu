  ...
  return (
    <div className="flex justify-center w-full">
      <div className="w-full pt-8 px-4" style={{ maxWidth: "1000px" }}>
        <p>
          Jitsu uses <a target="_blank" href="https://www.maxmind.com/">MaxMind</a> databases for geo resolution. There are two families
        ...
        <Form form={form} onFinish={submit}>
          <FormLayout>
            <FormField
              ...
              tooltip={
                <>
                  If enabled - Jitsu downloads <a target="_blank" href="https://www.maxmind.com/en/geoip2-databases">GeoIP Databases</a>{" "}
                  with your license key and enriches incoming JSON events with location based data. Read more
                  information about{" "}
                  <a target="_blank" href="https://jitsu.com/docs/other-features/geo-data-resolution">Geo data resolution</a>.
                </>
              }
              key="enabled"
            >
            ...
            <FormField
              ...
              tooltip={
                <>
                  Your MaxMind licence key. Obtain a new one in your <a target="_blank" href="https://www.maxmind.com/">Account</a>{" "}
                  ...
                  <a target="_blank" href="https://cloud.jitsu.com/">Jitsu.Cloud</a> and MaxMind isn't set - free GeoLite2-City and
