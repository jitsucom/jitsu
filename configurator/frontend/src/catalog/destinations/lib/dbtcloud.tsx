...
const dbtcloudDestination = {
  description: (
    <>
      ...
      linked Connectors. See{" "}
      <a href={"https://docs.getdbt.com/dbt-cloud/api-v2#operation/triggerRun"}>dbt Cloud API Docs</a>
  ...
  parameters: [
    ...
    },
    {
      ...
      required: true,
      type: stringType,
      documentation: <>Numeric ID of the dbt Cloud Account that the Job belongs to</>,
    },
    {
      ...
      required: true,
      type: stringType,
      documentation: <>Numeric ID of the Job to run</>,
    },
    {
      ...
      documentation: (
        <>
          A text description of the reason for running this job. The value is treated as{" "}
          <a href={"https://jitsu.com/docs/configuration/javascript-functions"}>JavaScript functions</a>
        </>
      ),
    },
    {
