  ...
  connectionSpecification: {
    ...
    properties: {
      ...
      requests_per_minute: {
        ...
        type: 'integer',
        description:
          'Number of requests per minute that this source allowed to use.'
      }
    }
  }
};
  ...
  connectionSpecification: {
    ...
    properties: {
      ...
      conversion_window_days: {
        ...
        type: 'integer',
        description:
          'Define the historical replication lookback window in days',
        minimum: 0,
        maximum: 1095,
        default: 14,
        examples: [14]
...
export const microsoftTeams = {
  documentationUrl:
    'https://docs.airbyte.io/integrations/sources/microsoft-teams',
  connectionSpecification: {
    $schema: 'http://json-schema.org/draft-07/schema#',
