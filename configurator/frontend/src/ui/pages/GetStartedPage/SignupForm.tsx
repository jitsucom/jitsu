...
export function SignupForm({ supportOauth }) {
  ...
  return <div>
    ...
    <div className="text-center mb-6">
      <b>
        <NavLink to="/">Log in</NavLink></b> if you have an account
    </div>
    <Form
      name="signup-form"
    ...
    >
      ...
      <Form.Item name="agreeToTos" className="signup-checkboxes">
        <Checkbox className={tosHighlight && 'border-b-2 border-error'} defaultChecked={true} checked={tosAgree} onChange={() => setTosAgree(!tosAgree)}>
          <span>I agree to <a href="https://jitsu.com/tos">Terms of Services</a> and <a href="https://jitsu.com/privacy">Privacy Policy</a></span>
