...
function GitHubLogo() {
  return <svg className="h-12 fill-current" viewBox="0 0 24 24" aria-hidden="true">
...
export default function GetStartedPage(props: GetStartedPageProps) {
  return <div className="flex flex-col lg:flex-row w-full min-h-screen">
    ...
    <div className="flex flex-col items-center lg:pt-36 ml-auto mr-auto pr-2 pl-2 pb-12">
      <a href="https://jitsu.com" className="block mb-6 lg:hidden"><img className="mt-8 h-8" src={logo}/></a>
      {props.login ?
