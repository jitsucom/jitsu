...
const DestinationEditorMappingsItem = ({ action, field, handleTypeChange, handleActionChange, handleDelete }: Props) => {
  return (
          ...
          action === 'constant' && (
            <Col className={styles.secondaryLabel} span={12}>
              <Form.Item
                ...
                label={<span style={{ whiteSpace: 'nowrap' }}>Value (<em>optional</em>): </span>}
                labelCol={{ span: 6 }}
                labelAlign="left"
              >
                <Input />
            ...
            <>
              <Col className={styles.secondaryLabel} span={7}>
                <Form.Item
                  ...
                  label={action === 'cast' ? <span>Type: </span> : <span>Type (<em>optional</em>): </span>}
                  labelCol={{ span: 11 }}
                  labelAlign="left"
              ...
              <Col className={styles.secondaryLabel} span={9}>
                <Form.Item
                  ...
                  label={<span>Column type (<em>optional</em>): </span>}
                  labelCol={{ span: 11 }}
                  labelAlign="left"
                >
                  <Input />
