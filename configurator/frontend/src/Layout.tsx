...
export const SlackChatWidget: React.FC<{}> = () => {
  return <div className="fixed bottom-5 right-5 rounded-full bg-primary text-text w-12 h-12 flex justify-center items-center cursor-pointer hover:bg-primaryHover">
