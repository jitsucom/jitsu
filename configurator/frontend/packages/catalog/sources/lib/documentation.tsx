...
export const googleProjectCreation = (
  <>
    ...
    <ul>
      <li>
        Go to the <a href="https://console.developers.google.com/">API Console page</a>
      </li>
      <li>Click "Select Project" if you have already had a project or click "Create Project" if not</li>
    </ul>
    Read more about{" "}
    <a href="https://support.google.com/googleapi/answer/6251787?hl=en#zippy=%2Ccreate-a-project">
      ...
      <ul>
        {oauthEnabled && (
          <li>
            ...
            <a href="https://console.cloud.google.com/">Google Cloud Console</a>) and get a refresh token. Jitsu
            developed a small <a href="https://github.com/jitsucom/oauthcli">CLI utility for obtaining the token</a>
          </li>
        )}
        ...
        <>
          ...
          <ul>
            ...
            <li>
              ...
              <a href="https://github.com/jitsucom/oauthcli">jitsucom/oauthcli</a>
            </li>
          </ul>
          <h2>
          ...
          <ul>
            <li>
              Go to the <a href="https://console.cloud.google.com/apis/credentials">API Credentials page</a>
            </li>
            <li>
          ...
          <a href="https://github.com/jitsucom/oauthcli">jitsucom/oauthcli</a> tool:
          <p>
            <code>
      ...
      {serviceAccountEnabled && (
        <>
          ...
          <ul>
            <li>
              Go to the{" "}
              <a href="https://console.developers.google.com/iam-admin/serviceaccounts">Service Accounts page</a>
            </li>
...
export const githubDocumentation: ConnectorDocumentation = {
  ...
  connection: (
    <>
      <ul>
        <li>
          Go to the <a href="https://github.com/settings/tokens">GitHub tokens</a> page
        </li>
        <li>
...
export const intercomDocumentation: ConnectorDocumentation = {
  overview: (
    <>
      ...
      <a href="https://developers.intercom.com/intercom-api-reference/v2.0/reference">Intercom v2.0 API</a>
      {": "}
  ...
  connection: (
    <ul>
      <li>
        Go to the <a href="https://app.intercom.com/a/developer-signup">Intercom Apps</a> page
      </li>
      <li>Click "New app"</li>
...
export const mixpanelDocumentation: ConnectorDocumentation = {
  ...
  connection: (
    <>
      <ul>
        <li>
          Go to the <a href="https://mixpanel.com/report">MixPanel Project settings</a> page
        </li>
...
export const shopifyDocumentation: ConnectorDocumentation = {
  ...
  connection: (
    <>
      ...
      <a href="https://shopify.dev/tutorials/generate-api-credentials">How to obtain API Key</a>
    </>
  ),
}
...
export const slackDocumentation: ConnectorDocumentation = {
  ...
  connection: (
    <ul>
      <li>
        Go to the <a href="https://api.slack.com/apps?new_app=1">creating Slack Apps</a> page
      </li>
      ...
      <li>
        Add the following Bot Token <a href="https://api.slack.com/docs/oauth-scopes">Scopes</a>: channels:history,
...
export const stripeDocumentation: ConnectorDocumentation = {
  overview: (
    <>
      The Stripe Connector pulls the following entities from <a href="https://stripe.com/docs/api">Stripe API</a> {": "}
      <a href="https://stripe.com/docs/api/balance_transactions/list">Balance Transactions</a>
      {", "}
      <a href="https://stripe.com/docs/api/charges/list">Charges</a>
      {", "}
      <a href="https://stripe.com/docs/api/coupons/list">Coupons</a>
      {", "}
      <a href="https://stripe.com/docs/api/customers/list">Customers</a>
      {", "}
      <a href="https://stripe.com/docs/api/disputes/list">Disputes</a>
      {", "}
      <a href="https://stripe.com/docs/api/events/list">Events</a>
      {", "}
      <a href="https://stripe.com/docs/api/invoices/list">Invoices</a>
      {", "}
      <a href="https://stripe.com/docs/api/invoiceitems/list">Invoice Items</a>
      <a href="https://stripe.com/docs/api/invoices/invoice_lines">Invoice Line Items</a>
      {", "}
      <a href="https://stripe.com/docs/api/payouts/list">Payouts</a>
      {", "}
      <a href="https://stripe.com/docs/api/plans/list">Plans</a>
      {", "}
      <a href="https://stripe.com/docs/api/products/list">Products</a>
      {", "}
      <a href="https://stripe.com/docs/api/subscriptions/list">Subscriptions</a>
      {", "}
      <a href="https://stripe.com/docs/api/subscription_items/list">Subscription Items</a>
      {", "}
      <a href="https://stripe.com/docs/api/transfers/list">Transfers</a>
      {", "}
      <a href="https://api.slack.com/methods/usergroups.list">User Groups</a>
    </>
  ),
  connection: (
    <ul>
      <li>
        Go to the <a href="https://dashboard.stripe.com/apikeys">Stripe Dashboard</a> page
      </li>
