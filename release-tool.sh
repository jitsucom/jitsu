...
function build_configurator() {
  ...
  cd configurator/frontend/ && yarn clean && yarn install --prefer-offline && CI=false ANALYTICS_KEYS='{"eventnative": "js.gpon6lmpwquappfl07tuq.ka5sxhsm08cmblny72tevi", "sentry": "https://f9f84b5bc4d943e493676539877af365@o330694.ingest.sentry.io/6360806"}' yarn build && \
