...
const darkSvg = (
  <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 46 46" style={svgStyle}>
    <defs>
...
const disabledSvg = (
  <svg width="100%" height="100%" viewBox="0 0 46 46" version="1.1" xmlns="http://www.w3.org/2000/svg" style={svgStyle}>
    <defs>
...
export const GoogleIcon: React.FC<{ disabled?: boolean; type?: "light" | "dark" }> = ({ disabled, type }) => (
