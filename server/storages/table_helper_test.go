...
return $
`
	p, err := schema.NewProcessor("test", "google_analytics",`events`, transormExpression, fieldMapper, []enrichment.Rule{}, schema.NewFlattener(nil), schema.NewTypeResolver(), false, identifiers.NewUniqueID("/eventn_ctx/event_id"), 20)
