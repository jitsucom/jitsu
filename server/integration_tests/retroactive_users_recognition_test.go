...
func TestPostgresRetroactiveUsersRecognition(t *testing.T) {
  ...
  "eventn_ctx": {
    ...
    "click_id": {}
			...
			objects, err := postgresContainer.GetAllSortedRows("recognition_events", "user_anonymous_id="+testData.anonymousId, "order by eventn_ctx_utc_time")
