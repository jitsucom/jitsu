...
export CLUSTER_ADMIN_TOKEN=${CLUSTER_ADMIN_TOKEN:=${CONFIGURATOR_ADMIN_TOKEN}}
export JITSU_CONFIGURATOR_URL=http://localhost:7000
export JITSU_SERVER_URL=http://localhost:8001
export GEO_RESOLVERS_URL="$JITSU_CONFIGURATOR_URL/api/v1/geo_data_resolvers?token=$CLUSTER_ADMIN_TOKEN"
export API_KEYS_URL="$JITSU_CONFIGURATOR_URL/api/v1/apikeys?token=$CLUSTER_ADMIN_TOKEN"
export DESTINATIONS_URL="$JITSU_CONFIGURATOR_URL/api/v1/destinations?token=$CLUSTER_ADMIN_TOKEN"
export SOURCES_URL="$JITSU_CONFIGURATOR_URL/api/v1/sources?token=$CLUSTER_ADMIN_TOKEN"
export TELEMETRY_URL="$JITSU_CONFIGURATOR_URL/api/v1/telemetry?token=$CLUSTER_ADMIN_TOKEN"
